...
def test_let_statement_array():
    ...
    # 测试 find
    assert LetArrayStatementHandler().findTargetStatement(unstructured_xml) == len(unstructured_xml)
    # 测试 is
    assert LetArrayStatementHandler().isTargetStatement(unstructured_xml) == True
...
def test_if_statement():
    ...
    # 测试 find
    assert IfStatementHandler().findTargetStatement(unstructured_xml) == len(unstructured_xml)
    # 测试 is
    assert IfStatementHandler().isTargetStatement(unstructured_xml) == True
...
def test_while_statement():
    ...
    # 测试 find
    assert WhileStatementHandler().findTargetStatement(unstructured_xml) == len(unstructured_xml)
    # 测试 is
    assert WhileStatementHandler().isTargetStatement(unstructured_xml) == True
...
def test_do_statement():
    ...
    # 测试 find
    assert DoStatementHandler().findTargetStatement(unstructured_xml) == len(unstructured_xml)
    # 测试 is
    assert DoStatementHandler().isTargetStatement(unstructured_xml) == True
...
def test_return_statement():
    ...
    # 测试 find
    assert ReturnStatementHandler().findTargetStatement(unstructured_xml) == len(unstructured_xml)
    # 测试 is
    assert ReturnStatementHandler().isTargetStatement(unstructured_xml) == True
...
def test_return_statement_void():
    ...
    # 测试 find
    assert VoidReturnStatementHandler().findTargetStatement(unstructured_xml) == len(unstructured_xml)
    # 测试 is
    assert VoidReturnStatementHandler().isTargetStatement(unstructured_xml) == True
...
def test_statement_let_statement():
    ...
    assert_answer(handler.toXML(), '''<letStatement> <keyword> let </keyword> <identifier> x </identifier> <symbol> = </symbol> <expression> <term> <intConst> 1 </intConst> </term> </expression> <symbol> ; </symbol> </letStatement>''')
    # 测试 find
    assert StatementHandler.findStatement(unstructured_xml) == len(unstructured_xml)
    # 测试 is
...
def test_statements_let_statement_complex():
    ...
    # 测试 is
    assert MultiStatementHandler.isMultiStatement(unstructured_xml) == True
...
def test_statements_do_statement_complex(): 
    _,unstructured_xml = segmentCodes('''do Output.printString("hello world"); Output.printInt(1);''')
    handler = MultiStatementHandler(unstructured_xml)
